classdef MinTimeCoGDoubleTrackInitialization < handle
    ...
    methods (Access = public)
        function obj = MinTimeCoGDoubleTrackInitialization(parameters)
            ...
            obj.tf_guess_ini = parameters.tf_guess_ini;
        ...
        function optimizer = OPTFormulation(obj)
            ...
            opti.set_initial(tf, obj.tf_guess_ini);
